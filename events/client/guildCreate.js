...
module.exports = async (client, guild) => {
    ...
    try {
        ...
        client.embed({
            ...
            fields: [{
                name: "📢┆Alert!",
                value: 'After more than 1 year we decided to stop Bot on April 15th, for more information go to [this server](https://discord.gg/BrPWT8fHmy)',
                inline: false,
            },
            {
                name: "❓┆How to setup?",
            ...
            },
            {
                ...
                value: `You can DM <@642899646816976897> for support or joining the [[Support server]](${client.config.discord.serverInvite})`,
                inline: false,
            },
            {
