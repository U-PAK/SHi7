...
module.exports = async (client, message) => {
  ...
  if (
    ...
    let row = new Discord.MessageActionRow().addComponents(
      new Discord.MessageButton()
        .setLabel("Invite")
        .setURL(
          "https://discord.com/api/oauth2/authorize?client_id=955198945292877824&permissions=8&scope=bot"
        )
        .setStyle("LINK"),
  ...
  if (command) {
    ...
    client.embed(
      {
        title: "👋・Hi, i'm 707",
        desc: `Bot is now completely in **/** commands. The current message commands have expired! Try our new improved commands and make your server better with Bot!`,
        fields: [
            {
            name: "❓┇I don't see any slash commands",
            value:
